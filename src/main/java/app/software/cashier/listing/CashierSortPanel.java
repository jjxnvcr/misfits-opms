...
import app.db.pojo.column.SaleItemColumn;
...
public class CashierSortPanel extends Page {
    private CashierList owner;

    public CashierSortPanel(CashierList owner) {
        ...
        SortButton idSortButton = new SortButton(SaleItemColumn.SaleItemID, "ID");
        ...
        SortButton itemPriceSortButton = new SortButton(SaleItemColumn.ItemPrice, "Price");
        itemPriceSortButton.setAction(sortAction(itemPriceSortButton));

        SortButton itemQuantitySortButton = new SortButton(SaleItemColumn.ItemQuantity, "Stock");
        itemQuantitySortButton.setAction(sortAction(itemQuantitySortButton));
        ...
        add(itemPriceSortButton);
        add(itemQuantitySortButton);
    }
